...
import BounceBall from "../../anim/BounceBall.jsx"
...
Since this file use .MDX, we can import JSX file.
```ts
import BounceBall from "../../anim/BounceBall.jsx"
<BounceBall client:load/>
```
> [!WARNING] This animation rendered by using Pixi.JS.
